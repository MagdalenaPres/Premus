...
export class Cart extends Component {
    ...
    render() {
        ...
        return (
            ...
            <p><button className="button-style" onClick={event =>  window.location.href='/delivery'}>Go to delivery options</button></p>
            </div>)}
            {products.length === 0 && <p id="page-name">No products in your cart</p>}
            </section>
        )
    }
}