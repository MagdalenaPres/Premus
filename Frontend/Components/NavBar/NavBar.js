    ...
    render() {
        ...
        <nav>
            <ul>
                ...
                <li className="nav-item">
                    <NavLink to="/favorite">
                    <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-suit-heart" viewBox="0 0 16 16">
                ...
                <li className="nav-item">
                    <NavLink to="/home/stationery">
                        Stationery
                    </NavLink>
                </li>
                <li className="nav-item">
                    <NavLink to="/home/folders and binders">
                        Folders and Binders
                    </NavLink>
                </li>
                <li className="nav-item">
                    <NavLink to="/home/paper">
                        Paper
                    </NavLink>
                </li>
                <li className="nav-item">
                    <NavLink to="/home/writing articles">
                        Writing articles
                    </NavLink>
                </li>
            </ul>
